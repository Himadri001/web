		...
		<div class="row" >
			<div class="col-sm-4  ">
				<ul class="log_ul ">
					...
					<li class="log_li"><a href="bangla.php">Bangla</a></li>
					<li class="log_li"><a href="english.php">English</a></li>
					<li class="log_li"><a href="science.php">Science</a></li>
					<li class="log_li"><a href="maths.php">Math</a></li>
				</ul>
			</div>
			<div  class="col-sm-8 " style="background-color: blue; height: 500px;">
