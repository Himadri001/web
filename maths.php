...
<div class="service-w3l">
	...
	<div class="service-grids">
		<div class="col-md-3 ser-grid left-nav">
			<nav class="">
				<ul class="log_ul" style="text-align: center; font-style: ">
					...
					<li class="log_li log_li_current"><a class="log_link" href="bangla.php">Bangla</a></li>
					...
					<li class="log_li active"><a class="log_link" href="maths.php">Math</a></li>
				</ul>
			</nav>
		</div>
		<div class="col-md-6 ser-grid ">
			<div class="ser-top ">
				<h4>Chap 1</h4>
				<p class="bod">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do labore et dolore magna aliqua.</p>
				<h4>Chap 2</h4>
				<p class="bod">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do labore et dolore magna aliqua.</p>
				<h4>Chap 3</h4>
				<p class="bod">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do labore et dolore magna aliqua.</p>
