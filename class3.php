...
<link href="css/log-in.css" rel="stylesheet" type="text/css" media="all" />
		...
		<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					...
					<li class="s-bar">
						<div class="search">
							<label class="icon-search "><a href="index.php"><span class="glyphicon glyphicon glyphicon-log-out text-capitalize" > Logout</a>
						</div>
					</li>
				</ul>
			</div>
...
<div class="service-w3l">
	<div class="w3layouts_head">
		<h3 class="tittle">Student Panel</h3>
		<div class="border"></div>
	</div>				
	<div class="service-grids">
		<div class="col-md-3 ser-grid left-nav">
			<nav class="menu_li">
				<ul class="log_ul" style="text-align: center; font-style: ">
					<li class="log_li sub " style="background-color: #01a2a6; font-size: 25px;" >Subjects</li>
					<li class="log_li"><a class="log_link" href="bangla.php">Bangla</a></li>
					<li class="log_li"><a class="log_link" href="english.php">English</a></li>
					<li class="log_li"><a class="log_link" href="science.php">Science</a></li>
					<li class="log_li"><a class="log_link" href="maths.php">Math</a></li>
					<li class="log_li"><a class="log_link" href="maths.php">Bangladesh Studies</a></li>
					<li class="log_li"><a class="log_link" href="maths.php">Geography</a></li>
					<li class="log_li"><a class="log_link" href="maths.php">General Knowledge</a></li>
					
				</ul>
			</nav>
		</div>
		<div class="col-md-9 ser-grid">
			<div class="ser-top bod" >
				<h4>Notice board</h4>

<?php
$connect = mysqli_connect("localhost","root","");
	mysqli_select_db($connect,"rsa")  or die(mysqli_error("rsa")) ;
	$qry=mysqli_query($connect,"SELECT * FROM Notice");
while($row=mysqli_fetch_array($qry))
	...
	<!-- <div class="navbar">
		...
		<div class="student_nav col-md-6">
			<ul class="log_ul ">
				<li class="log_li sub">Subjects</li>
				<li class="log_li"><a href="bangla.html">Bangla</a></li>
				<li class="log_li"><a href="english.html">English</a></li>
				<li class="log_li"><a href="science.html">Science</a></li>
				<li class="log_li"><a href="maths.html">Math</a></li>
			</ul>
		</div>
		<div style="margin-left:25%;padding:1px 16px;" class="col-md-6"> 
