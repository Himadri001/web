...
<!-- about -->
		...
		<div class="container">
			...
			<div class="col-md-6 banner_bottom_right">
				<div class="wthree_banner_bottom_right_grids">
					<div class="col-md-5 banner_bottom_right_grid">
					...
					<div class="col-md-7 banner_bottom_right_grid">
						<div class="view view-tenth">
							<div class="agile_text_box">
								<i class="fa fa-cog" aria-hidden="true"></i>
								<h3>Best Learning Methods</h3>
	...
	while($row=mysqli_fetch_array($res))
	{
		...
		?> 
			<div class="agile_team_grids col-md-offset-2" style="font-size: 75%" >
