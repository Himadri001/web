		...
		<div class="col-md-3 ser-grid left-nav">
			<nav class="">
				<ul class="log_ul" style="text-align: center; font-style: ">
					...
					<li class="log_li active"><a class="log_link" href="bangla.php">Bangla</a></li>
...
$connect = mysqli_connect("localhost","root","");
	...
	$colum=$_SESSION["standard"];
	echo $colum;
	//$sqry=CONCAT("SELECT * FROM", $colum);
	//$sqry="SELECT * FROM " ."1";
	//echo $sqry;
	$qry=mysqli_query($connect,$sqry);
...
$name=$row['link'];
		...
		<div class="col-md-6 ser-grid ">
			<div class="ser-top ">
				<h4><?php echo "Chap". " " . $id?></h4>
				
				<?php echo "<a href='watch.php?id=$id'>$name</a>"?>
			</div>
		</div>
		...
		?>
		<div class="col-md-3 ser-grid bod">
			<div class="ser-top">	
				<h4>Notice Board</h4>
